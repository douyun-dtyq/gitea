...
export class GitIdentityPicker extends HTMLElement {
  ...
  private renderPresetControl() {
    ...
    const icon = createElementFromHTML<SVGElement>(octiconTriangleDown);
  ...
  private renderCustomControl() {
    ...
    const restoreIcon = createElementFromHTML<SVGElement>(octiconX);
    restoreIcon.setAttribute('width', '14');
    restoreIcon.setAttribute('height', '14');
