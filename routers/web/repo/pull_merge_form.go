...
func (prInfo *pullRequestViewInfo) prepareMergeBoxFormProps(ctx *context.Context) {
	...
	mergeFormProps := map[string]any{
		...
		"textCommitterIdentity":                ctx.Locale.TrString("repo.editor.commit_identity"),
		"textCommitterIdentityCustom":          ctx.Locale.TrString("repo.editor.commit_identity_custom"),
		"textCommitterIdentityPlaceholder":     ctx.Locale.TrString("repo.editor.commit_identity_placeholder"),
		"textCommitterIdentityInvalidFormat":   ctx.Locale.TrString("repo.editor.commit_identity_invalid_format"),
		"textCommitterIdentityUnverifiedEmail": ctx.Locale.TrString("repo.editor.commit_identity_unverified_email"),
		"textCommitterIdentityLoadError":       ctx.Locale.TrString("repo.editor.commit_identity_load_error"),
		"textCommitterIdentityRestore":         ctx.Locale.TrString("repo.editor.commit_identity_restore"),
